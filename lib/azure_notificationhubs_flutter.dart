...
class AzureNotificationhubsFlutter {
  static const MethodChannel _channel = const MethodChannel('azure_notificationhubs_flutter');
  ...
  void configure(
      {MessageHandler? onMessage, MessageHandler? onResume, MessageHandler? onNotificationClicked, MessageHandler? onLaunch, TokenHandler? onToken}) {
